...
class TypeMapRuleSpec extends ObjectBehavior
{
    ...
    {
        $context->getType()->willReturn(new Type('MyNamespace', 'SomeType', [], new TypeMeta()));
    ...
    {
        $context->getType()->willReturn(new Type('MyNamespace', 'UnknownType', [], new TypeMeta()));
    ...
    {
        $context->getType()->willReturn(new Type('MyNamespace', 'NullType', [], new TypeMeta()));
        $this->appliesToContext($context)->shouldReturn(false);
    }
